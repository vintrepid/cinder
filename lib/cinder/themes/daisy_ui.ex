defmodule Cinder.Themes.DaisyUI do
  ...
  set :table_toolbar_class,
      "sticky top-16 z-40 mb-3 flex h-12 flex-nowrap items-center gap-3 overflow-x-auto border-b border-base-300 bg-base-100/95 px-3 py-1 shadow-sm backdrop-blur"
